...
@section('page_title', __('cms::post.create.page_title'))

@section('page_subtitle', __('cms::post.create.page_subtitle'))
...
@section('breadcrumb')
    <nav aria-label="breadcrumb" class="col-sm-4 order-sm-last mb-3 mb-sm-0 p-0 ">
        <ol class="breadcrumb d-inline-flex font-weight-600 fs-13 bg-white mb-0 float-sm-right">
            ...
            <li class="breadcrumb-item active">{{ trans('cms::post.create.breadcrumb') }}</li>
        </ol>
    </nav>
@stop

@section('content')
    <form action="{{ route('cms.admin.post.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
